#!/usr/bin/python3
"""Defines a funtion that divides all elements of a matrix.

Attributes:
    matrix_divided: divides all element of a matrix.
    """
...
def matrix_divided(matrix, div):
    ...
    Raises:
        TypeError: If matrix is not a list of lists of integers
                    or floats
        TypeError: If each row of th ematrix isn't of the same size.
